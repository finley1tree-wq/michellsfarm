...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mitchell's Farm — Saanich Peninsula, est. 1862" },
      ...
      { name: "author", content: "Mitchell's Farm" },
      { property: "og:title", content: "Mitchell's Farm — Saanich Peninsula, est. 1862" },
      ...
      { name: "twitter:title", content: "Mitchell's Farm — Saanich Peninsula, est. 1862" },
